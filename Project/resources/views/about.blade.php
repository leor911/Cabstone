            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i class="fa fa-check text-primary me-3"></i>Expert Guidance at Every Step:<br> Our team of real estate professionals is dedicated to providing personalized service to meet your unique needs. From the initial search to the final closing, we're with you every step of the way.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>A Wide Range of Options:<br> With an extensive portfolio of properties, we offer something for everyone. Whether you're a first-time buyer or looking to invest, you'll find a variety of options to choose from.</p>
                        <p><i class="fa fa-check text-primary me-3"></i>Commitment to Quality:<br> We believe in the power of a happy home. That's why we only list properties that meet our high standards of quality and comfort, ensuring that you find a place you love.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3">Contact With Our Certified Realtors</h1>
                                ...
                                <a href="{{ url('/realtor') }}" class="btn btn-primary py-3 px-4 me-2"><i class="fa fa-search me-2"></i>Find Realtor</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<p>At our core, we're more than just a retail business – we're a dedicated team united in achieving your property dreams. With seamless collaboration and unwavering support, we ensure your journey is not just successful, but truly exceptional.</p>
                </div>
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item rounded overflow-hidden">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    <a class="btn btn-square mx-1" href="https://www.facebook.com/profile.php?id=100022635125174"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href="https://www.instagram.com/leor_ag79/"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                            <div class="text-center p-4 mt-3">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <h1 class="mb-4">What do we provide?</h1>
