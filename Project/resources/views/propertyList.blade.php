        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <table>
                    ...
                    <tr>
                        <td>{{ $listing->houseID }}</td>
                        {{-- <td>{{ $test->reatorID }}</td> --}}
                        <td>{{ $listing->price }}</td>
                        <td>{{ $listing->description }}</td>
                        <td>{{ $listing->prknSize }}</td>
                        <td>{{ $listing->acreSize }}</td>
                        <td>{{ $listing->squareFeet }}</td>
                        <td>{{ $listing->homeType }}</td>
                        <td>{{ $listing->archType }}</td>
                        <td>{{ $listing->roof }}</td>
                        <td>{{ $listing->country }}</td>
                        <td>{{ $listing->state }}</td>
                        <td>{{ $listing->city }}</td>
                        <td>{{ $listing->bedroomNo }}</td>
                        <td>{{ $listing->bathNo }}</td>
                        <td>{{ $listing->kitchenNo }}</td>
                    </tr>
                    @endforeach
                </table>
                {{-- <div class="tab-content">
